        ...
        <main className="contenido_repuestos">
            ...
            <main id="productoContenedor">
                <div className="modeloContenedor">
                    <div className="modeloCarrito">
                        <p className="texto_compra">Tu compra:</p>
                        <button id="cerrarCarrito"><i className="fas fa-times-circle"></i></button>
                        <div id="carrito-contenedor">
                        </div>
                        <p className="texto_compra">Precio total: $<span id="precioTotal"></span></p>
                    </div>
                </div>
            </main> */}
        </main>
